...
export function WalletsView({ openDepositOnMount, onDepositMountConsumed, openWithdrawalOnMount, onWithdrawalMountConsumed, priceList = [], onOpenWithdrawalAddress, onOpenWithdrawalPassword }: WalletsViewProps) {
  const { t } = useLanguage()
